...
data = readmatrix('Haefner_Figure_12_13_14_15_Data.xlsx','Sheet','Sheet1');
...
xlabel('$Pareto \; Solution$','Interpreter','latex','FontSize',14)
ylabel({'$$Feed \; Volumetric \; Flowrate$$','$$Q_f \; [m^3/hr]$$'},'Interpreter','latex','FontSize',14)
...
xlabel('$Pareto \; Solution$','Interpreter','latex','FontSize',14)
ylabel({'$$Concentrate \; Volumetric \; Flowrate$$','$$Q_c \; [m^3/hr]$$'},'Interpreter','latex','FontSize',14)
...
xlabel('$Pareto \; Solution$','Interpreter','latex','FontSize',14)
ylabel({'$$Permeate \; Volumetric \; Flowrate$$','$$Q_p \; [m^3/hr]$$'},'Interpreter','latex','FontSize',14)
