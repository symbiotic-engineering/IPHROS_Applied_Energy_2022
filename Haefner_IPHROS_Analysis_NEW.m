% Matthew Haefner
% Applied Energy
% IPHROS MOGA Post-Optimization Analysis

%% Loading in optimization results

data = readmatrix('Opt_Results_eta_RO_obj_NEW.xlsx','Sheet','Sheet1');
...
zlabel('$\eta_{RO}$', 'Interpreter','latex','FontSize',14)
view(60,30)
...
xlabel('$\dot{E}_{er}$', 'Interpreter','latex','FontSize',18)
ylabel('$\eta_{RO}$', 'Interpreter','latex','FontSize',18)
...
ylabel('$S_{ht} \; [g/kg]$','Interpreter','latex','FontSize',14)
ylim([35 40.5])
...
xlabel('$Pareto \; Solution$','Interpreter','latex','FontSize',14)
ylabel('$Q_f \; [m^3/hr]$','Interpreter','latex','FontSize',14)
...
xlabel('$Pareto \; Solution$','Interpreter','latex','FontSize',14)
ylabel('$Q_c \; [m^3/hr]$','Interpreter','latex','FontSize',14)
...
xlabel('$Pareto \; Solution$','Interpreter','latex','FontSize',14)
ylabel('$Q_p \; [m^3/hr]$','Interpreter','latex','FontSize',14)
...
xlabel('$Pareto \; Solution$','Interpreter','latex','FontSize',14)
ylabel('$rr \; [-]$','Interpreter','latex','FontSize',14)
...
xlabel('$Pareto \; Solution$','Interpreter','latex','FontSize',14)
ylabel('$NDP \; [Pa]$','Interpreter','latex','FontSize',14)
...
function J = objective(x)
    ...
    load('ro_weights.mat','weights1','weights2','weights3','weights4','weights5','weights6','weights7','weights8','weights9','weights10')
