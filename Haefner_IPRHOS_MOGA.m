% Matthew Haefner
% SEA Lab
% IPHROS Multi-Objective Genetic Algorithm Optimization
% 11/22/22
...
ub = [100e6 0.99 0.99 821 8 8 1.86e6 1.86e6];
nonlcon = @constraints;
intcon = [5,6,7,8];

options = optimoptions('gamultiobj','Display','iter');%,'UseParallel', true, 'UseVectorized', false);
...
results = [E_er_array,V_fwRO_array,eta_RO_array];
