...
data = readmatrix('..\data\Haefner_Figure_6_Data.xlsx');
...
set(gca,'XLim',[2e6 max([P_f_bad;P_f_good])],'YLim',[35 55])
...
zlabel({'$$Feed \; Volumetric \; Flowrate$$', '$$Q_f \; [m^3/h]$$'},'Interpreter','latex','FontSize',14)
